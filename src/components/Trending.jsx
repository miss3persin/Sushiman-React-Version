  ...
  return (
    ...
    <section className="trending-sushi">
      <div className="trending__content" data-aos="fade-right">
        ...
        <ul className="trending__list flex-between">
          ...
          <li>
            <div className="trending__icon flex-center"><img src={check} alt="check"/></div>
            <p>Make Sushi</p>
          </li>
      ...
      <div className="trending__image flex-center">
        ...
        <div className="trending__arrow trending__arrow-left"><img src={arrow_vertical} alt="arrow-vertical"/></div>
        <div className="trending__arrow trending__arrow-bottom"><img src={arrow_horizontal} alt="arrow-horizontal"/></div>
      </div>
    </section>
    ...
    <section className="trending-drink">
      <div className="trending__image flex-center">
        ...
        <div className="trending__arrow trending__arrow-top"><img src={arrow_horizontal} alt="arrow-horizontal"/></div>
        <div className="trending__arrow trending__arrow-right"><img src={arrow_vertical} alt="arrow-vertical"/></div>
      </div>
